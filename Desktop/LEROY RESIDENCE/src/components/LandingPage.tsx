      ...
      <section className="hero pb-2 md:pb-4">
        <div className="w-full flex flex-col items-center">
          <div className="hero-title-banner flex-col">
            ...
            <p className="text-xs md:text-base text-center text-blue-100/90 font-medium mt-2 max-w-2xl mx-auto tracking-normal px-4">
              Nuestro análisis entrega un valor de tasación multifactorial y un valor sugerido de venta
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-2 mb-2 w-full max-w-6xl px-4 items-stretch">
            <div className="valuation-pillar p-2 md:p-3">
              <div className="pillar-icon mb-1">
                <Calculator className="w-5 h-5 md:w-6 h-6" />
              </div>
